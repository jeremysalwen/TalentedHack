...
tarballs: autotalent_lv2.so
	cd ..; rm autotalent_source.tar.gz; tar -czvf autotalent_source.tar.gz autotalent.lv2/*.c autotalent.lv2/*.h autotalent.lv2/dependencies autotalent.lv2/*.ttl autotalent.lv2/Makefile;
